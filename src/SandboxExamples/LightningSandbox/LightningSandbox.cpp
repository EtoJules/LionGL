...
void LightningSandbox::onUpdate(double deltaTime)
{
    ...
    m_shader.setUniform4f("u_LightPosition", -1.5f, 0.8f, 2.0f, 1.0f);
    ...
    //draw cube objects
    {
        glm::mat4 nModel = glm::translate(glm::mat4(1.0f), glm::vec3(3.3f, -3.0f, 4.0f));
        m_shader.setUniformMat4f("u_Model", nModel);
        m_renderer.draw(m_vertexArray, m_indexBuffer, m_shader);
    }
    //draw lights
    {
        glm::mat4 nModel = glm::translate(glm::mat4(1.0f), glm::vec3(-1.5f, 0.8f, 2.0f));
