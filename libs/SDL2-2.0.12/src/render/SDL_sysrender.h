...
/* Define the SDL2 texture structure */
struct SDL_Texture
{
    const void *magic;
    ...
    SDL_Surface *locked_surface;  /**< Locked region exposed as a SDL2 surface */
...
/* Define the SDL2 renderer structure */
struct SDL_Renderer
{
    const void *magic;
...
/* Define the SDL2 render driver structure */
