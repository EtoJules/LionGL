...
/* The SDL2 game controller structure */
...
/*
 * Return 1 if the game controller should be ignored by SDL2
 */
...
/*
 * Get the SDL2 joystick layer binding for this controller axis mapping
 */
