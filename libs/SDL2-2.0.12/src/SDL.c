...
#else
        return SDL_SetError("SDL2 not built with events support");
#endif
    }
...
#else
        return SDL_SetError("SDL2 not built with timer support");
#endif
    }
...
#else
        return SDL_SetError("SDL2 not built with video support");
#endif
    }
...
#else
        return SDL_SetError("SDL2 not built with audio support");
#endif
    }
...
#else
        return SDL_SetError("SDL2 not built with joystick support");
#endif
    }
...
#else
        return SDL_SetError("SDL2 not built with haptic (force feedback) support");
#endif
    }
...
#else
        return SDL_SetError("SDL2 not built with sensor support");
#endif
    }
