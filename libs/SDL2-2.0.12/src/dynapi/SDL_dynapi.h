...
/* IMPORTANT:
   ...
   have to hand-edit an internal source file in SDL2 to turn it off; you
   ...
   hard to update your SDL2 in the field, and impossible if you've statically
   linked SDL2 into your app. Understand that platforms change, and if we can't
   drop in an updated SDL2, your application can definitely break some time
   in the future, even if it's fine today.
   To be sure, as new system-level video and audio APIs are introduced, an
   updated SDL2 can transparently take advantage of them, but your program will
