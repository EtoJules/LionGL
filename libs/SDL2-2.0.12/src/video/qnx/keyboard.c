...
/**
 * A map thta translates Screen key names to SDL2 scan codes.
 ...
 * Translates the event such that it can be handled by SDL2.
...
handleKeyboardEvent(screen_event_t event)
{
    ...
    // Translate to an SDL2 scan code.
