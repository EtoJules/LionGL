...
/**
 * Creates a new native Screen window and associates it with the given SDL2
 * window.
 * @param   _THIS
 * @param   window  SDL2 window to initialize
 * @return  0 if successful, -1 on error
 */
static int
createWindow(_THIS, SDL_Window *window)
{
    ...
    // Set the native window's size to match the SDL2 window.
    size[0] = window->w;
    size[1] = window->h;
 ...
 * @param       _THIS
 * @param       window  SDL2 window to get the buffer for
...
/**
 * Updates the size of the native window using the geometry of the SDL2 window.
 * @param   _THIS
 * @param   window  SDL2 window to update
 */
static void
...
/**
 * Makes the native window associated with the given SDL2 window visible.
 * @param   _THIS
 * @param   window  SDL2 window to update
 */
static void
...
/**
 * Makes the native window associated with the given SDL2 window invisible.
 * @param   _THIS
 * @param   window  SDL2 window to update
 */
static void
...
/**
 * Destroys the native window associated with the given SDL2 window.
 * @param   _THIS
 * @param   window  SDL2 window that is being destroyed
 */
static void
...
/**
 * Creates the QNX video plugin used by SDL2.
