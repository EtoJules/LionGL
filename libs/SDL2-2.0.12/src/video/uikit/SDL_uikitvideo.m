...
VideoBootStrap UIKIT_bootstrap = {
    UIKITVID_DRIVER_NAME, "SDL2 UIKit video driver",
...
UIKit_SuspendScreenSaver(_THIS)
{
    @autoreleasepool {
        ...
        /* FIXME: The idle timer hint should be deprecated for SDL2 2.1. */
...
{
#if !TARGET_OS_TV
    /* Force the main SDL2 window to re-evaluate home indicator state */
 ...
 * iOS log support.
 *
 * This doesn't really have aything to do with the interfaces of the SDL2 video
