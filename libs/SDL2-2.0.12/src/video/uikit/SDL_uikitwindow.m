...
UIKit_CreateWindow(_THIS, SDL_Window *window)
{
    @autoreleasepool {
        ...
        /* SDL2 currently puts this window at the start of display's linked list. We rely on this. */
...
{
    /* We don't currently offer a concept of "raising" the SDL2 window, since
...
UIKit_DestroyWindow(_THIS, SDL_Window * window)
{
    @autoreleasepool {
        if (window->driverdata != NULL) {
             ...
             * We want to make sure the SDL2 view controller isn't accessed in
...
UIKit_GetWindowWMInfo(_THIS, SDL_Window * window, SDL_SysWMinfo * info)
{
    @autoreleasepool {
        ...
        if (info->version.major <= SDL_MAJOR_VERSION) {
            ...
            /* These struct members were added in SDL2 2.0.4. */
