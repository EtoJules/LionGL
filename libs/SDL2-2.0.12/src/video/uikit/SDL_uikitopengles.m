...
- (void)dealloc
{
     ...
     * SDL2 window that it's attached to. */
...
UIKit_GL_CreateContext(_THIS, SDL_Window * window)
{
    @autoreleasepool {
        ...
        /* construct our view, passing in SDL2's OpenGL configuration data */
...
UIKit_GL_RestoreCurrentContext(void)
{
    @autoreleasepool {
        /* Some iOS system functionality (such as Dictation on the on-screen
         ...
         expected SDL2-created OpenGL ES context is active after the OS is
