...
#ifdef WIZ_GLES_LITE
    "wiz",
    "SDL2 Wiz Video Driver",
#else
    "pandora",
    "SDL2 Pandora Video Driver",
#endif
    PND_available,
    PND_create
};
...
/*****************************************************************************/
/* SDL2 Video and Display initialization/handling functions                   */
/*****************************************************************************/
int
PND_videoinit(_THIS)
{
...
/*****************************************************************************/
/* SDL2 OpenGL/OpenGL ES functions                                            */
/*****************************************************************************/
int
...
PND_gl_createcontext(_THIS, SDL_Window * window)
{
    ...
    if(!hNativeWnd)
        ...
        printf( "SDL2: Wiz framebuffer allocated: %X\n", hNativeWnd );
    }
    else {
        printf( "SDL2: Wiz framebuffer already allocated: %X\n", hNativeWnd );
    }
...
PND_gl_deletecontext(_THIS, SDL_GLContext context)
{
    ...
    if( hNativeWnd != 0 )
    {
      free(hNativeWnd);
      hNativeWnd = 0;
      printf( "SDL2: Wiz framebuffer released\n" );
    }
#endif
