    ...
    /* Copy the selection from our own CUTBUFFER to the requested property */
        case SelectionRequest: {
            ...
            /* !!! FIXME: We were probably storing this on the root window
               because an SDL2 window might go away...? but we don't have to do
    ...
    */
    ...
    case KeyPress:{
            ...
            if (videodata->key_layout[keycode] == SDL_SCANCODE_UNKNOWN && keycode) {
                ...
                fprintf(stderr,
                        "The key you just pressed is not recognized by SDL2. To help get this fixed, please report this to the SDL2 forums/mailing list <https://discourse.libsdl.org/> X11 KeyCode %d (%d), X11 KeySym 0x%lX (%s).\n",
            ...
            if (X11_IsWheelEvent(display,&xevent,&xticks, &yticks)) {
                ...
                if(button == Button1) {
                    ...
                    /* X button values 4-7 are used for scrolling, so X1 is 8, X2 is 9, ...
                       => subtract (8-SDL_BUTTON_X1) to get value SDL2 expects */
