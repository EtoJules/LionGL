...
/* Define the SDL2 window-shaper structure */
...
/* Define the SDL2 shape driver structure */
...
/* Define the SDL2 window structure, corresponding to toplevel windows */
struct SDL_Window
{
    const void *magic;
    Uint32 id;
...
/*
 * Define the SDL2 display structure.
...
/* Define the SDL2 video driver structure */
