...
WIN_ShowOldMessageBox(const SDL_MessageBoxData *messageboxdata, int *buttonid)
{
     ...
     * I'm assuming a dialog box in SDL2 is rare enough we can to the create.
     */
 ...
 * This is because SDL2 targets Windows XP (0x501), so this is not defined in the platform SDK.
 */
