...
/* NSOpenGL implementation of SDL2 OpenGL support */
...
- (void)setWindow:(SDL_Window *)newWindow
{
    ...
    if (newWindow) {
        ...
        /* This should never be nil since sdlContentView is only nil if the
           window was created via SDL_CreateWindowFrom, and SDL2 doesn't allow
...
#else
        SDL_SetError("SDL2 not configured with EGL support");
        return NULL;
#endif
    }
