...
- (void)insertText:(id)aString replacementRange:(NSRange)replacementRange
{
     ...
     * to test and convert it before return as SDL2 event */
...
- (void)doCommandBySelector:(SEL)myselector
{
    /* No need to do anything since we are not using Cocoa
       selectors to handle special keys, instead we use SDL2
...
Cocoa_HandleKeyEvent(_THIS, NSEvent *event)
{
    ...
    case NSEventTypeKeyDown:
        ...
        if (code == SDL_SCANCODE_UNKNOWN) {
            fprintf(stderr, "The key you just pressed is not recognized by SDL2. To help get this fixed, report this to the SDL2 forums/mailing list <https://discourse.libsdl.org/> or to Christian Walther <cwalther@gmx.ch>. Mac virtual key code is %d.\n", scancode);
        }
#endif
