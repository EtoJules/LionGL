...
// nextEventMatchingMask in SDL2, as well as events caught by other
...
{
    /* The menu bar of SDL2 apps which don't have the typical .app bundle
...
{ @autoreleasepool
{
    ...
    if (NSApp == nil) {
        ...
        if ([NSApp delegate]) {
            /* The SDL2 app delegate calls this in didFinishLaunching if it's
