...
SDL_Convert51ToStereo(SDL_AudioCVT * cvt, SDL_AudioFormat format)
{
    ...
    /* SDL2's 5.1 layout: FL+FR+FC+LFE+BL+BR */
...
/* SDL2's resampler uses a "bandlimited interpolation" algorithm:
                  ...
                  SDL_AudioFormat dst_fmt, Uint8 dst_channels, int dst_rate)
{
    ...
    /* Type conversion goes like this now:
       ...
       it was a bloat on SDL2 compile times and final library size. */
