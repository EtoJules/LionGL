...
{
    char name[QSA_MAX_NAME_LENGTH];     /* Long audio device name for SDL2  */
    int cardno;
    int deviceno;
} QSA_Device;
...
/* !!! FIXME: does this need to be here? Does the SDL2 version not work? */
static void
...
QSA_Init(SDL_AudioDriverImpl * impl)
{
    ...
    /* provided by SDL2, which uses pthread_mutex for lock/unlock */
